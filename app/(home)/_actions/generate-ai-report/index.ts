...
import { GenerateAiReportShema } from "./schema";
...
export const generateAiReport = async ({ month }: GenerateAiReportShema) => {
  console.log("Mês passado para gerar o relatório:", month);
  if (!isMatch(month, "MM")) {
